...
>
> 서버가 포털을 직접 순회하지 않습니다. `robots.txt` 가 목록 페이지를 Disallow 하고 있어,
> **사용자가 이미 연 페이지의 DOM** 만 확장이 백엔드로 보냅니다.
...
> 공공 서버를 배려해 요청 간 1초를 둡니다. 한 번에 최대 60개까지만 모으며,
> 사용자가 URL 을 등록했을 때만 동작합니다. 스케줄러나 자동 재수집은 없습니다.
